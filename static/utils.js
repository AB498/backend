...
let CustomModal = ({ open, onClose, children }) => {
  ...
  return (
    ...
    ReactDOM.createPortal(
      show ? (
        <div className={`${show ? "block" : "hidden"} grid place-items-center fixed top-0 left-0 z-50 h-screen w-screen bg-black/25 dark:bg-white/25 overscroll-none overflow-auto `} onClick={() => onClose(open)}>
